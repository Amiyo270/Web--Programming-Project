...
const HomePage = ({ movies, onSelectMovie, onAddMovie, onEditMovie, onDeleteMovie, theme }) => {
  ...
  return (
    <div className={`min-h-screen px-4 py-10 ${isDark ? 'bg-slate-950 text-slate-100' : 'bg-slate-100 text-slate-900'}`}>
      <div className="mx-auto max-w-7xl space-y-10">
        <section className={`rounded-[2rem] border p-6 shadow-2xl shadow-black/20 backdrop-blur-xl ${isDark ? 'border-white/10 bg-slate-950/80' : 'border-slate-200 bg-white/85'}`}>
